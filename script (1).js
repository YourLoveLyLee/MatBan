...
function renderNextUp(schedule) {
  ...
  el.innerHTML = `
    <div class="next-up-top">
      <span class="next-up-when">${formatDateDisplay(next.Date)} &middot; ${escapeHtml(formatTimeDisplay(next.Time))}</span>
...
function renderSchedule(schedule) {
  ...
  el.innerHTML = upcoming.map((g) => `
    <div class="game-card">
      <p class="date">${formatDateDisplay(g.Date)} &middot; ${escapeHtml(formatTimeDisplay(g.Time))}</p>
